...
import {AvailableCurrenciesActionType, AvailableCurrenciesActionTypes} from "../../types/available-currencies-types";
...
export const getAvailableCurrencies = () => {
    return async (dispatch: Dispatch<AvailableCurrenciesActionType>) => {
        try {
            dispatch({type: AvailableCurrenciesActionTypes.GET_AVAILABLE_CURRENCIES});
            const options = {
                method: 'GET',
