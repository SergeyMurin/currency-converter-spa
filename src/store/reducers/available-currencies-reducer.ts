...
export const availableCurrenciesReducer = (state = initialState, action: AvailableCurrenciesActionType) => {
    switch (action.type) {
        ...
        case AvailableCurrenciesActionTypes.GET_AVAILABLE_CURRENCIES_SUCCESS: {
            return {loading_status: false, error: null, success: true, symbols: action.currencies};
        }
